...
saveDirectory = 'raymond'
#create save directory
if not os.path.exists(saveDirectory): #make folder if doesn't exist
    os.makedirs(saveDirectory)
  
#csv source url
#url = 'https://drive.google.com/uc?export=download&id=1LqAk1xIyuNq0ynJK8mkuvBTgxXCOK2SH' #big circle
url = 'https://drive.google.com/uc?export=download&id=1ith3awBE8vTcpVGo6o3SVQj2aZhW5f4o' #raymond's
#url = 'https://drive.google.com/uc?export=download&id=1M6I4BP4ZFkuD_gF8XBmljCutsn2JTwng' #squircle star
...
def makeImg(numterms):
  ...
  plt.savefig(saveDirectory+'/'+f"{numterms:03d}") #need to change the f string to match the number of digits in the num of points there are
  plt.close()
